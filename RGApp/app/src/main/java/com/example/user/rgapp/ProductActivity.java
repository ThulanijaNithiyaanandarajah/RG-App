...
public class ProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txtAddToCart = (TextView)findViewById(R.id.cart);
        TextView txtBuyToCart = (TextView)findViewById(R.id.buy);
        ...
        CustomJSONObjectRequest jsObjRequest = new CustomJSONObjectRequest(Request.Method.POST, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    JSONArray item_versions = dataObject.getJSONArray("item_versions");
