...
public class CategoryListAdapter extends BaseExpandableListAdapter {
    ...
    public CategoryListAdapter(Context context, List<String> listDataHeader, HashMap<String, List<SubCategory>> listChildData) {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(_context, List_View.class);
                intent.putExtra("sub_name", subCategory.sub_name);
                intent.putExtra("sub_link", subCategory.sub_link);
